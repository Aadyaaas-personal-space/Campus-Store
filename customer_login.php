...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $customer['password'])) {
            ...
            $redirect = isset($_GET['redirect']) && $_GET['redirect'] === 'checkout' ? 'checkout.php' : 'customer_dashboard.php';
...
<head>
    ...
    <title>Customer Login - Campus Store</title>
    ...
    <div class="animate__animated animate__fadeIn">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="customer_login.php">👤 Login</a></li>
        ...
        <div class="container mt-5">
            ...
            <div class="w-50 mx-auto slide-in">
                ...
                <?php endif; ?>
                <form action="customer_login.php<?php echo isset($_GET['redirect']) ? '?redirect=' . $_GET['redirect'] : ''; ?>" method="POST">
                    <div class="mb-3">
